...
inline bool operator<(glm::vec2& v1, glm::vec2 v2) { return v1.x < v2.x && v1.y < v2.y; }
inline bool operator>(glm::vec2& v1, glm::vec2 v2) { return v1.x > v2.x && v1.y > v2.y; }

inline bool operator<=(glm::vec2& v1, glm::vec2 v2) { return !(v1 > v2); }
inline bool operator>=(glm::vec2& v1, glm::vec2 v2) { return !(v1 < v2); }

// @todo add proper operator+= and operator -= to glm ?

inline glm::vec2 xproj(glm::vec2& vec) { return glm::vec2{ vec.x, 0.0f }; }
inline glm::vec2 yproj(glm::vec2& vec) { return glm::vec2{ 0.0f, vec.y }; }
